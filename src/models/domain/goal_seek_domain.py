...
class GoalSeekDomain:
    """
    Dominio que implementa la lógica de Goal Seek para encontrar el valor de prima_asignada
    ...
    def execute_goal_seek(
        ...
        try:
            ...
            for cobertura in coberturas:
                ...
                print(f"   Iteraciones: {self._iterations}")
