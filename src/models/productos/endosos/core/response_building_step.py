...
def _get_default_endosos_values() -> Dict[str, Any]:
    """
    Obtiene los valores por defecto para el producto ENDOSOS
...
def _load_parametros_almacenados_por_cobertura(coberturas: List[str]) -> Dict[str, Any]:
    ...
    for cobertura in coberturas_ordenadas:
        try:
            ...
            step = ParameterLoadingStep("endosos", cobertura)
...
def build_endosos_response(
    ...
    Args:
        ...
        endosos: Datos específicos de endosos calculados
...
def build_default_endosos_response() -> Dict[str, Any]:
    """
    Construye una respuesta de ejemplo para ENDOSOS con datos por defecto
    ...
    # Datos de endosos calculados de ejemplo
    endosos = {
        "coberturas": {
            "fallecimiento": {
                "tasas": {
    ...
    return build_endosos_response(
        parametros_entrada, parametros_almacenados, parametros_calculados, endosos
    )


def build_endosos_response_from_request(request_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Construye la respuesta de ENDOSOS basada en los datos de la petición
    ...
    # Inicializar estructuras vacías para parámetros calculados y endosos
    parametros_calculados = {
